...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'gcs' => [
            'driver' => 'gcs',
            'key_file_path' => env('GCS_KEY_FILE', base_path('service-account.json')), // optional: /path/to/service-account.json
            'key_file' => [], // optional: Array of data that substitutes the .json file (see below)
            'project_id' => env('GCS_PROJECT_ID', 'your-project-id'), // optional: is included in key file
